...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] left-[-10%] w-[400px] h-[400px] bg-indigo-600/10 rounded-full blur-[80px] pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-card border border-border rounded-3xl shadow-xl p-8 z-10 animate-slide-up">
        <h1 className="text-2xl font-bold text-foreground mb-2">Crear cuenta libre</h1>
        <p className="text-muted text-sm mb-6">Únete para llevar un control estricto de tus finanzas.</p>
